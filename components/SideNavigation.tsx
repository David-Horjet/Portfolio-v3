...
const SideNavigation: React.FC = () => {
  return (
    <div className="fixed left-0 top-0 h-full hidden lg:flex flex-col items-center gap-4 z-50 ml-4 pointer-events-none">
      <div className="w-px h-32 bg-gray"></div>
      <div className="flex flex-col gap-4 pointer-events-auto">
        {/* Placeholder icons for social media */}
        <Link href={"https://github.com/David-Horjet"} className="cursor-pointer group">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" className="text-gray group-hover:text-primary transition-colors">
